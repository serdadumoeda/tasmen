...
<head>
    ...
    <title>Global Dashboard - Kepala Pusdatik</title>
                    ...
                    <div class="lg:col-span-2 bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                        ...
                        <div class="space-y-4">
                            @foreach ($allProjects as $project)
                                <a href="{{ route('projects.show', $project) }}" class="block p-4 border rounded-lg hover:bg-gray-50">
                                    <div class="flex justify-between">
                                        ...
                                        <div class="text-right">
                                            <p class="font-semibold">{{ $project->tasks->where('status', 'completed')->count() }} / {{ $project->tasks->count() }} Tugas</p>
