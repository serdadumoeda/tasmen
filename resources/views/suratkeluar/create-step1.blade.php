                ...
                <div class="p-6 sm:p-8 text-gray-900">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        @forelse ($templates as $template)
                            <a href="{{ route('surat-keluar.create.from-template', ['template_id' => $template->id, 'suratable_id' => $suratable_id ?? null, 'suratable_type' => $suratable_type ?? null]) }}" class="block p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-xl hover:border-indigo-500 transition-all duration-300 transform hover:-translate-y-1">
