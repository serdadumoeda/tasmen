                    ...
                    <div class="bg-yellow-50 p-4 rounded-lg shadow lg:col-span-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            ...
                            <div class="p-4 bg-white rounded-lg border">
                                ...
                                <p class="text-xs text-gray-600 mb-2">IKI mengukur kinerja individu berdasarkan progres tugas dan efisiensi waktu. <strong class="text-gray-800">Nilai Dasar</strong> adalah rata-rata progres semua tugas yang dibobot berdasarkan prioritasnya.</p>
